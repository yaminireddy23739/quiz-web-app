...
- Skip and Next question options  
...
- Preventing score from increasing on multiple clicks  
- Handling option selection logic correctly  
- Managing timer start and stop for each question  
...
- Importance of logic and state management  
